    ...
    def parse_image(self, image_path: str):
        ...
        Args:
            image_path (str): Path to the image file,
                ake sure this is the full path,
                e.g: ./src/test-images/single_event.png

        Returns:
            str list: list of events extracted from the image
                        ...
                        "content": [
                            {
                                ...
                                "text": """
                                        ...
                                        **At the very minimum get a title and a date and time from the image**,
                                        - if there appear to be multiple different events in the image, return each one as a separate field in the JSON object,
                                        - if there appears to be an event with a sub event
                                            --eg: a class with separate lecture and discussion component, or a large event with small sub events like a hackathon with multiple workshops
                                        ...
                                        do your best to include every piece of text in the image even if it doesn't seem relevant it is better to be exhaustive than miss details,
                                        if you are unsure about a piece of text make your best interpretation and, include it in the JSON object
                                        """,
                            },
                            {
                                "type": "image_url",
