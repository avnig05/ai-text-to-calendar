...
function Container({ children }: { children: React.ReactNode }) {
  return <section className="flex flex-col gap-6 w-full max-w-3xl mx-auto">{children}</section>
}
...
// Inner dot circles
function Dot() {
  return <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full border-2 border-[#218F98] bg-white -mt-1" />
}
...
// Hidden file input
const HiddenFileInput = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
